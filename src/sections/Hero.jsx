  ...
  return (
    ...
    >
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
            ...
            font-bold  leading-normal max-mobile:text-4xl'>
            ...
            leading-8 mt-6 mb-14 sm:max-w-sm'>
                Discover stylish Nike arrivals, quality<br /> comfort, 
            ...
            w-full mt-20 gap-16'>
                {statistics.map((stat) =>(
                    <div key={stat.label}>
                        <p className='text-4xl max-mobile:text-3xl font-palanquin font-bold'>{stat.value}</p>
        ...
        max-xl:py-40 bg-primary bg-hero bg-cover bg-center max-mobile:w-[380px] max-mobile:mx-auto'>
            <img 
                src={bigShoeImg}
                alt='shoe collection'
                width={610}
